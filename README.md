...
### - Limitations of Revenue as a Performance Metric  
  - Revenue contribution reflects volume, not necessarily quality.
  - Lower contributing channels still generate a prominent portion of revenue (**~35% combined**).
  - Key factors such as: AOV, return rates (revenue lost), revenue after losses need to be accounted for.

 ### - Emerging Questions
   - Are top performing channels driving high value/loyal customers or just transactions?
   - And do these channels possess holes in the transaction process leading to potential revenue loss?
...
#### Affiliate
  ...
  - On top of that, it possesess the highest revenue lost to returns (**10.62%**), highest amongst all channels.
...
#### Referral, Direct   
  - Referral and Direct both pose an interesting situation. Operational and behavioural return rates of both channels comfortably sit in the green. However, both possess an elevated revenue lost to returns sitting at **9.03%** and **7.63%**.
  - The pinpoint of this cannot be derived from the data alone, and the rate could be high due to low revenue bases to begin with. The absence of clear return reasons may reflect data limitations. Customers not providing feedback, making it difficult to isolate a root cause.
...
#### Social 
  - Social has the lowest behavioural return rate (**2.32%**) but its operational return rate is an issue (**4.02%, the second highest**). Customers acquired through this channel are satisfied with what they receieve, but there are fulfillment issues which need to be evaluated.
### Cancellation Rates:  
...
<img width="2144" height="1160" alt="image" src="https://github.com/user-attachments/assets/e202197c-5bc3-45f6-9173-7d7b344ceaf9" />
